...
The weather entity will provide the current state of the weather as well as provide detailed forecasts for daily, hourly and twice-daily.

## Sensors

The integration will create entities showing the current state of some additional weather metrics.
